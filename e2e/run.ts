...
function run(): number {
  ...
  if (!['h-1080p-10s.mp4', 'h-720p-25fps-8s.mp4', 'v-1080x1920-12s.mp4', 'ana-1280x720-sar-6s.mp4', 'overlay-beep.wav'].every((name) => existsSync(join(repoDir, 'test-media', name)))) {
